          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {mode === "signup" && (
              <div className="space-y-2">
                <Label htmlFor="name" className="text-xs text-white/60 uppercase tracking-widest">
                  Full Name
                </Label>
                <Input
                  id="name"
                  ...
                  className="bg-white/5 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-white/30 focus-visible:border-white/40 rounded-none h-12"
                />
              </div>
            )}

            <div className="space-y-2">
              <Label htmlFor="email" className="text-xs text-white/60 uppercase tracking-widest">
                Email Address
              </Label>
              <Input
                id="email"
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-xs text-white/60 uppercase tracking-widest">
                Password
              </Label>
              <div className="relative">
                <Input
                  ...
                  className="bg-white/5 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-white/30 focus-visible:border-white/40 rounded-none h-12 pr-12"
                />
                <button
                  type="button"
                  tabIndex={-1}
            ...
            {/* Error message */}
            {error && (
              <div className="border border-white/20 bg-white/5 px-4 py-3 text-sm text-white/80">
                {error}
              </div>
            )}
